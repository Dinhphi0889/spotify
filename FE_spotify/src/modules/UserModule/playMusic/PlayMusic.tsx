    ...
    const handleDrawerComment = () => {
        ...
        return (
            <div>
                ...
                >
                    <div>
                        <div className='comment-item mb-4' key='0'>
                            <div className='flex items-start'>
                                {/* Avatar */}
                                <img
                                ...
                                <div className='comment-content'>
                                    {/* User name and comment content */}
                                    <div className='bg-white p-3 rounded-2xl mb-1'>
                                        <span className='text-md font-medium text-black'>Nguyễn Văn A</span>
                                        <br />
                                        <span className='ml-2 text-black'>ABC</span>
                                    </div>
                                    {/* Time */}
                                    <p className='text-sm text-gray-500'>
                                        30/10/2024
                        ...
                        <div className='comment-item mb-4' key='0'>
                            <div className='flex items-start'>
                                ...
                                <div className='comment-content'>
                                    {/* User name and comment content */}
                                    <div className='bg-white p-3 rounded-2xl mb-1'>
                                        <span className='text-md font-medium text-black'>Nguyễn Văn B</span>
                                        <br />
                                        <span className='ml-2 text-black'>ABC</span>
                                    </div>
                                    {/* Time */}
                        ...
                        <div className='flex items-center'>
                            ...
                            <div className='flex items-center bg-white rounded-2xl p-2'>
                                ...
                                {/* Post button with icon */}
                                <button className='ml-2 text-black px-4 py-1 rounded-full hover:text-gray-400 transition-all duration-150 flex items-center'>
                                    <i className="fa-solid fa-paper-plane mr-1"></i> {/* Icon for paper plane */}
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-around">
                        ...
                        <div className="flex items-center">
                         <img
                            ...
                            <div>
                                <div className="text-sm font-semibold">Tên bài hát</div>
                                <div className="text-xs text-gray-400">Tên ca sĩ</div>
                            </div>
                        </div>
